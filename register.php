...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(e){
                $('#first_name').keyup(finction(){
                    var first_name= $(this).val();
                    var first_nameerror = $('#first_nameerror');

                    var phpfile= 'check.php';

                    if(first_name !=''){
                        $.post(phpfile,{checkfirst_name: first_name}, function(data){
                            $('#first_nameerror').html(data);
                        });
                    }
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5 bg-warning">
            ...
            <div class="my-5 container bg-warning">
                <form class="cmxform" id="signupForm" method="post" class="row g-3" action="#">
                    <div class="row">
                        <div class="col-md-4">
                            <label for="first_name" class="form-label">First Name<span>*</span></label>
                            <input type="text" minlength="2" name="first_name" class="form-control"
                                aria-label="First name" id="first_name" required />

                        </div>
                        <div class="col-md-4">
                            <label for="middle_name" class="form-label">Middle Name</label>
                            <input type="text" name="middle_name" class="form-control" aria-label="Middle Name"
                                id="middle_name">
                            <span id="middle_nameerror" class="text-danger font-weight-bold"></span>
                        </div>
                        <div class="col-md-4">
                            <label for="last_name" class="form-label">Last Name<span>*</span></label>
                            <input type="text" name="last_name" class="form-control" aria-label="Last name"
                        ...
                        <div class="card card-body bg-warning">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="primary_address2"
                                        name="primary_address2" placeholder="Apartment, studio, or floor">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" id="current_address2"
                                            name="current_address2" placeholder="Apartment, studio, or floor">
                    ...
                    <div class="card bg-warning ">
                        ...
                        <div class="card card-body bg-warning">
                            ...
                            <div class="row">
                                ...
                                <div class="col-8 ">
                                    <label for="education_1_institute" class="form-label">Institute or University
                                        Name</label>
                                    <input type="text" class="form-control" name="education_1_institute"
                                        id="education_1_institute">
                            ...
                            <div class="card card-body bg-warning">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-8 ">
                                        ...
                                        <input type="text" class="form-control" id="education_2_institute"
                                            name="education_2_institute">
                                        <span id="education_2_instituteerror"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" class="form-control" id="edication_2_marks"
                                            name="edication_2_marks">
                                ...
                                <div class="card card-body bg-warning">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <span id="education_3_levelerror"
                                                class="text-danger font-weight-bold"></span>
                                        </div>


                                        <div class="col-8 ">
                                            <label for="education_3_institute" class="form-label">Institute or
                                                University
                                                Name</label>
                                            <input type="text" class="form-control" id="education_3_institute"
                                                name="education_3_institute">
                                            <span id="education_3_instituteerror"
                                                class="text-danger font-weight-bold"></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="card card-body bg-warning">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="date" class="form-control" id="xp_2_start"
                                                placeholder="Birth Date" name="xp_2_start">
                                            <span id="xp_2_starterror" class="text-danger font-weight-bold"></span>
                                        </div>

                                        <div class="col-md-4">
                                            <label for="xp_2_end" class="form-label">End Date</label>
                                            <input type="date" class="form-control" id="xp_2_end"
                                                placeholder="Birth Date" name="xp_2_end">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="date" class="form-control" id="xp_3_start"
                                                        name="xp_3_start" placeholder="Birth Date">
                                                    <span id="xp_3_starterror"
                                                        class="text-danger font-weight-bold"></span>
                                                </div>
                    ...
                    <div class="col-12">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="term" name="term" required>
